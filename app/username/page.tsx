...
import { useConvex, useMutation, useQuery, Authenticated, Unauthenticated, AuthLoading } from 'convex/react'
          ...
          <form.Field
            ...
            validators={{
              ...
              onChangeAsync: async ({ value }) => {
                if (!value || value.length < 3 || value.length > 30 || !/^[a-zA-Z0-9._-]+$/.test(value)) {
                  return undefined
                }
                ...
                try {
                  ...
                  const exists = await convex.query(api.users.checkUsername, { username: value })
              ...
              return (
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    />
                    {(field.state.meta.isValidating || currentUser === undefined) && (
          ...
          <form.Subscribe
            ...
            children={([username, isSubmitting, canSubmit]) => {
              ...
              return (
                <Button
                  type="submit"
                  disabled={!canSubmit || isLoading || currentUser === undefined || !hasUsernameChanged}
                  className="w-full mt-2 py-5 font-semibold"
                >
                  {isLoading ? <Spinner size="small" className="text-white" /> : 'save'}
                </Button>
              );
            }}
          />
